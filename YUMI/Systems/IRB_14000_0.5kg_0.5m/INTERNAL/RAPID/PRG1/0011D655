MODULE MainModule
	VAR robtarget p20:=[[123.61,156.94,178.62],[0.367323,0.741513,-0.346174,0.442036],[-1,0,-1,11],[152.879,9E+09,9E+09,9E+09,9E+09,9E+09]];
	VAR robtarget p30;
	VAR num P20_X:=0;
	VAR num P20_Y:=0;
    VAR num P20_Z:=0;
